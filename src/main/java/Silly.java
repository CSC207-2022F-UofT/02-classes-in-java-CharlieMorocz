...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two strings as arguments and concatenates them into this Silly object's name.
     *
     * @param first the first string in this Silly instance's name.
     * @param second the second string in this Silly instance's name.
     */
